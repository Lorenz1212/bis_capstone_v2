...
<div class="container">
    ...
    if ($result->num_rows > 0) {
        // Output table header
        echo "<table class='table table-bordered' border='1' id='residentRequestTableList'>
                <tr>
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            echo "<tr>
                    ...
                    <td class='center'>  
                        <a href='#' onclick='openEditPopupFormEdit(" . json_encode($row) . ")'>
                        ...
                        <a href='#' onclick='viewResidentInfo(" . json_encode($row) . ")'>
